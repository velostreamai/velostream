...
../../target/release/velo-test scaffold . -y
```
...
```bash
# Custom project name
../../target/release/velo-test scaffold . --name "My Quickstart" -y

# Force a specific style
../../target/release/velo-test scaffold . --style minimal -y

# Custom output path
../../target/release/velo-test scaffold . --output ./run-tests.sh -y
```
