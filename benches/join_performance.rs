...
fn benchmark_join_types_comparison(c: &mut Criterion) {
    ...
    let join_queries = vec![
        ("inner_join", "SELECT * FROM left_stream INNER JOIN right_stream ON left_stream.id = right_stream.right_id"),
        ("left_join", "SELECT * FROM left_stream LEFT JOIN right_stream ON left_stream.id = right_stream.right_id"),
        ("right_join", "SELECT * FROM left_stream RIGHT JOIN right_stream ON left_stream.id = right_stream.right_id"),
        ("full_outer_join", "SELECT * FROM left_stream FULL OUTER JOIN right_stream ON left_stream.id = right_stream.right_id"),
    ];
