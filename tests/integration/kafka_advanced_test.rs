...
async fn test_multiple_user_workflow() {
    ...
    let consumer = FastConsumer::<String, User>::from_brokers(
        broker,
        &group_id,
        JsonSerializer,
        JsonSerializer,
...
async fn test_cross_topic_messaging() {
    ...
    // Create consumers
    let user_consumer = FastConsumer::<String, User>::from_brokers(
        broker,
        &group_id,
        JsonSerializer,
        JsonSerializer,
    ...
    let product_consumer = FastConsumer::<String, Product>::from_brokers(
        broker,
        &group_id,
        JsonSerializer,
        JsonSerializer,
    ...
    let order_consumer = FastConsumer::<String, OrderEvent>::from_brokers(
        broker,
        &group_id,
        JsonSerializer,
        JsonSerializer,
