//! Detailed profiling of TUMBLING window financial analytics performance
//!
//! This test instruments the TUMBLING window benchmark to compare with SESSION window performance.
...
#[tokio::test]
#[serial]
async fn profile_tumbling_window_financial_analytics() {
