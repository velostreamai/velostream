...
pub use unified::{
    PropertySuggestor, StructConfigSuggestor, BatchConfigApplicator, 
    ConfigFactory, ConfigLogger, defaults
};
...
pub use legacy::{
    BatchConfig, BatchStrategy, CdcFormat, CompressionType, ConnectionString, 
    FileFormat, SinkConfig, SourceConfig, WriteMode
};