...
//! for FerrisStreams. It supports multiple configuration sources with priority
...
pub struct EnvironmentConfig {
    /// Environment variable prefix (default: "FERRIS_")
    pub prefix: String,
...
impl EnvironmentConfig {
    ...
    pub fn new() -> Self {
        Self {
            prefix: "FERRIS_".to_string(),
            config_files: vec![
                "./ferrisstreams.toml".to_string(),
                "./config/ferrisstreams.yaml".to_string(),
                "~/.config/ferrisstreams/config.json".to_string(),
                "/etc/ferrisstreams/config.yaml".to_string(),
            ],
