...
//!
//! ```rust,no_run
//! use ferrisstreams::ferris::sql::execution::aggregation::AggregationEngine;
...
use crate::ferris::sql::execution::internal::{GroupAccumulator, GroupByState};
...
impl AggregationEngine {
    ...
    pub fn create_group_by_state(
        ...
        select_fields: Vec<crate::ferris::sql::ast::SelectField>,
