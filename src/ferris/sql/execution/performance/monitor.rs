...
mod tests {
    ...
    fn test_performance_monitor_basic() {
        ...
        assert_eq!(performance.records_processed, 1000);
        assert_eq!(performance.bytes_processed, 10000);
    }
    ...
    fn test_prometheus_export() {
        ...
        assert!(prometheus_output.contains("ferrisstreams_queries_total"));
    ...
    #[test]
    fn test_monitored_execution_trait() {
        let monitor = PerformanceMonitor::new();
