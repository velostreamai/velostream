...
impl JoinContext {
    ...
    pub fn get_right_record_with_context(
        &self,
        source: &StreamSource,
        _window: &Option<crate::velostream::sql::ast::JoinWindow>,
    ...
    pub fn get_right_record(
        &self,
        source: &StreamSource,
        window: &Option<crate::velostream::sql::ast::JoinWindow>,
    ) -> Result<Option<StreamRecord>, SqlError> {
    ...
    fn create_basic_fallback_record(table_name: &str) -> Result<Option<StreamRecord>, SqlError> {
        ...
        match table_name {
            "products" => {
                fields.insert(
                    "id".to_string(),
                    crate::velostream::sql::execution::FieldValue::Integer(1),
                );
                fields.insert(
                    "name".to_string(),
                    crate::velostream::sql::execution::FieldValue::String("Product 1".to_string()),
                );
                fields.insert(
                    "owner_id".to_string(),
                    crate::velostream::sql::execution::FieldValue::Integer(100),
                );
                fields.insert(
                    "category".to_string(),
                    crate::velostream::sql::execution::FieldValue::String(
            ...
            "users" => {
                ...
                fields.insert(
                    "name".to_string(),
                    crate::velostream::sql::execution::FieldValue::String("Test User".to_string()),
                );
                fields.insert(
                    "email".to_string(),
                    crate::velostream::sql::execution::FieldValue::String(
            ...
            _ => {
                ...
                fields.insert(
                    "name".to_string(),
                    crate::velostream::sql::execution::FieldValue::String(format!(
                        "Fallback {}",
                        table_name
                    )),
                );
        ...
        Ok(Some(crate::velostream::sql::execution::StreamRecord {
            fields,
