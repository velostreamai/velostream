...
mod tests {
    ...
    use crate::velostream::sql::execution::performance::{PerformanceMonitor, QueryTracker};
    ...
    fn test_prometheus_metrics_export() {
        ...
        assert!(prometheus_output.contains("velostream_queries_total 3"));
        assert!(prometheus_output.contains("velostream_records_processed_total"));
        assert!(prometheus_output.contains("velostream_bytes_processed_total"));
    }
