...
use crate::velostream::sql::config::validation::ConfigValidatorRegistry;
use crate::velostream::sql::config::{ConfigSource, DataSourceConfig, ValidationError};
...
impl DataSourceConfigBuilder {
    ...
    pub fn try_build(
        ...
        (
            DataSourceConfig,
            Vec<crate::velostream::sql::config::validation::ValidationWarning>,
        ),
        ConfigurationError,
    > {
        if self.validator.is_none() {
        ...
        templates.insert(
            ...
            ConfigTemplate {
                ...
                config: {
                    ...
                    config.set_parameter("group_id", "velostream-dev");
